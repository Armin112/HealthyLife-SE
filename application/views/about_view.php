  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="page-title-name">
          <h1>About us</h1>
          <p>We are listed some interesting facts about our company. Read it bellow.</p>
        </div>
          <ul class="page-breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-double-right"></i></li>
            <li><a href="#">About us</a> <i class="fa fa-angle-double-right"></i></li>
    ...
    <div class="row justify-content-center">
       <div class="col-lg-10">
          <div class="section-title text-center">
            ...
            <p>HealthyLife – For Healthy Body</p>
          </div>      
      </div>
    </div>
     <div class="row justify-content-center">
  ...
  <div class="row">
    <div class="col-md-8">
      <div class="section-title">
          ...
          <h2 class="title-effect">Users Opinions & Reviews</h2>
        </div>
    </div>
  </div>
 <div class="row">
  <div class="col-lg-6">
   <div class="owl-carousel" data-nav-arrow="false" data-nav-dots="true" data-items="1" data-lg-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1">
      <div class="item"><div class="testimonial bottom_pos light">
        <div class="testimonial-avatar"> <img alt="" src="images/review-template.jpg"> </div>
 ...
 <div class="col-lg-6 sm-mt-50">
      <div class="clients-list clients-border column-3">
         <ul class="list-unstyled">
           <li> 
              <img class="img-fluid mx-auto" src="images/client-template.png" alt="">
           </li>
           <li> 
              <img class="img-fluid mx-auto" src="images/client-template.png" alt="">
           </li>
